...
def _camera_to_domain(m: CameraModel) -> Camera:
    ...
    return Camera(
        ...
        retention_days_pending=m.retention_days_pending,
        retention_pending_from=m.retention_pending_from,
...
class CameraRepository:
    ...
    async def create(self, camera: Camera) -> Camera:
        ...
        model = CameraModel(
            ...
            retention_days_pending=camera.retention_days_pending,
            retention_pending_from=camera.retention_pending_from,
